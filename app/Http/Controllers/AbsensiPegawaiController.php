...
class AbsensiPegawaiController extends Controller
{
    ...
    public function banyak_bulan(Request $request)
    {
        try {
            $activePeriod = AttendancePeriod::where('is_active', true)->first();
            ...
            Log::info('Akses halaman absensi pegawai banyak bulan', [
                'user_id' => auth()->id(),
                'tahun' => $tahun,
                'tw' => $tw,
                'ip' => $request->ip(),
            ...
            dd($pegawaiList);
            return view('absensi.banyak-bulan', compact(
                'pegawaiList',
                'tahun',
                'tw',
                'bulanTW'
            ...
            Log::error('Gagal membuka halaman absensi pegawai banyak bulan', [
                'message' => $e->getMessage(),
                'user_id' => auth()->id(),
                'ip' => $request->ip(),
            ]);

            return back()->with('swal_error', 'Gagal membuka halaman absensi pegawai banyak bulan.');
        }
    }
}
