...
@section('title', 'Detail Penonaktifan Pegawai')
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="fw-bold">Detail Penonaktifan Pegawai</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('penonaktifan-pegawai.index') }}" class="btn btn-secondary btn-sm">
