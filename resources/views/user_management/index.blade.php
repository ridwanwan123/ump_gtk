...
@push('styles')
<style>
    .user-card { border-radius: 12px; transition: all .3s ease; }
    .user-card:hover { transform: translateY(-4px); box-shadow: 0 8px 20px rgba(0,0,0,.08); }
    .table td, .table th { vertical-align: middle; white-space: nowrap; }
    .badge-role { font-size: 0.75rem; padding: 0.35em 0.6em; }
    .btn-action { padding: 0.25rem 0.45rem; }
    .card-footer {
